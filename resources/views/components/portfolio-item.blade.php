...
<div
x-data="{itemsection: {{ json_encode($itemsection) }},
        categories: {{ json_encode($categories) }} }"

{{-- :class="(selectedSection == 'Intelligence Artificielle' && (selectedTab == 'allIA' || categories.includes(selectedTab))) ? 'block' : 'hidden' " --}}

{{-- :class="(itemsection==selectedSection ) && categories.includes(selectedTab) ? 'block' : 'hidden' " --}}

:class="(itemsection == selectedSection && (categories.includes(selectedTab) || selectedTab==selectedSection)) ? 'block' : 'hidden'"
